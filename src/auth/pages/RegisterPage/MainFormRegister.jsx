...
const MainFormRegister = () => {
  ...
  const formValidations = {
    ...
    password: [
      ...
      "Su contraseña debe contener entre 8 y 16 caracteres y al menos: un numero, una letra mayuscula, una letra minuscula y un caracter especial",
    ],
    passwordCheck: [
  ...
  const onSubmit = (event) => {
    ...
    if (isFormValid()) {
      ...
      dispatch(register(first_name, last_name, email, password, passwordCheck));
    }
  };
    ...
    <>
      <form onSubmit={onSubmit}>
        <Grid container>
          ...
          >
            {errorAccountExist
              ? "Error, la cuenta de usuario ya existe con el email introducido."
...
export default MainFormRegister;
